...
class MapsControllerTest < ActionController::TestCase
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post :create, map: { address: @map.address, body: @map.body, latitude: @map.latitude, longitude: @map.longitude, title: @map.title }
    end
  ...
  test "should update map" do
    patch :update, id: @map, map: { address: @map.address, body: @map.body, latitude: @map.latitude, longitude: @map.longitude, title: @map.title }
    assert_redirected_to map_path(assigns(:map))
  end
